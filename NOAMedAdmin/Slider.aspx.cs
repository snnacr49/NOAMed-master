...
public partial class Slider : System.Web.UI.Page
{
    ...
    {
        var list = new DataProcessNoa.Data.NOAEntities().Slider.Where(u=>u.IsActive==true).OrderByDescending(u=>u.ID).ToList();
