...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
	...
	showPopup('AddBlog.aspx','Add-Edit Blog',800,750);
}" />
                                        </dx:ASPxButton>
                                    </td>
                ...
                <Items>
                    ...
                    <dx:GridViewToolbarItem Command="ExportToCsv" />
                                ...
                                <Columns>
                                    ...
                                    <dx:GridViewDataTextColumn Caption="Short Content" ShowInCustomizationForm="True" VisibleIndex="3" FieldName="ShortContent">
                                    </dx:GridViewDataTextColumn>
                                    ...
                                    <dx:GridViewCommandColumn ButtonRenderMode="Image" ButtonType="Image" ShowInCustomizationForm="True" VisibleIndex="0" Width="100px" ShowClearFilterButton="True">
                                        <CustomButtons>                                           
                                            <dx:GridViewCommandColumnCustomButton ID="btnRemove">
                                                <Image IconID="spreadsheet_removepivotfield_16x16" ToolTip="Remove Blog">
                                                </Image>
                                            </dx:GridViewCommandColumnCustomButton>
                                           
                                            <dx:GridViewCommandColumnCustomButton ID="btnEditBlog">
                                                 <Image IconID="mail_editcontact_16x16" ToolTip="Edit Blog">
                                                </Image>
                                            </dx:GridViewCommandColumnCustomButton>
