<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddSlider.aspx.cs" Inherits="AddSlider" %>
                ...
                <PanelCollection>
                    <dx:PanelContent runat="server">
                        <table class="dx-justification">
                            ...
                            <tr>
                                <td>
                                    <dx:ASPxMemo ID="txtcontent" runat="server" Height="71px" Width="100%">
                                    </dx:ASPxMemo>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td>
                                    <dx:ASPxTextBox ID="txtkeyword" runat="server" ClientInstanceName="txtTitle" Width="100%">
                                    </dx:ASPxTextBox>
                                </td>
                            </tr>
                            <tr>
