...
public partial class Blog : System.Web.UI.Page
{
    ...
    {
        var list = new DataProcessNoa.Data.NOAEntities().Blog.Where(u=>u.IsActive==true).OrderByDescending(u=>u.ID).ToList();
