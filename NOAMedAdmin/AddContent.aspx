...
<dx:PanelContent runat="server">
    <table class="dx-justification">
        ...
        <tr>
            <td>
                <dx:ASPxTextBox ID="txtCategory" runat="server" Width="100%">
                </dx:ASPxTextBox>
            </td>
        </tr>
        <tr>
            <td class="auto-style1">Short Name</td>
        </tr>
        <tr>
            <td class="auto-style1">
                <dx:ASPxTextBox ID="txtshortname" runat="server" Width="100%">
                </dx:ASPxTextBox>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td>
                <dx:ASPxHtmlEditor ID="htmlshort" runat="server" Width="100%">
                    <settingshtmlediting>
