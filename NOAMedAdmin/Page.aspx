<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="Page.aspx.cs" Inherits="Page" %>
                ...
                <Items>
                    ...
                    <dx:GridViewToolbarItem Command="ExportToCsv" />
                                ...
                                <Columns>
                                    ...
                                    <dx:GridViewDataTextColumn Caption="Total Name" ShowInCustomizationForm="True" VisibleIndex="3" FieldName="TotalName">
                                    ...
                                    <dx:GridViewCommandColumn ButtonRenderMode="Image" ButtonType="Image" ShowInCustomizationForm="True" VisibleIndex="0" Width="100px" ShowClearFilterButton="True">
                                        <CustomButtons>
                                            <dx:GridViewCommandColumnCustomButton ID="btnEditPage">
                                                <Image IconID="mail_editcontact_16x16" ToolTip="Edit Page">
                                                </Image>
                                            </dx:GridViewCommandColumnCustomButton>
                                            <dx:GridViewCommandColumnCustomButton ID="btnRemove">
                                                <Image IconID="spreadsheet_removepivotfield_16x16" ToolTip="Remove Page">
                                                </Image>
                                            </dx:GridViewCommandColumnCustomButton>
