<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="Videos.aspx.cs" Inherits="Videos" %>
                            ...
                            <table class="dxeBinImgCPnlSys">
                                <tr>
                                    <td style="width: 100px;">
                                        <dx:ASPxButton ID="ASPxButton1" runat="server" AutoPostBack="False" Text="Add New Video">
            ...
            <dx:GridViewToolbar>
                ...
                <Items>
                    ...
                    <dx:GridViewToolbarItem Command="ExportToCsv" />
                                ...
                                <Columns>
                                    <dx:GridViewDataTextColumn Caption="Video ID" ShowInCustomizationForm="True" VisibleIndex="1" FieldName="ID">
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="Name" ShowInCustomizationForm="True" VisibleIndex="2" FieldName="Name">
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="Video URL" ShowInCustomizationForm="True" VisibleIndex="3" FieldName="VideoUrl">
                                    </dx:GridViewDataTextColumn>                                    
                                    <dx:GridViewCommandColumn ButtonRenderMode="Image" ButtonType="Image" ShowInCustomizationForm="True" VisibleIndex="0" Width="100px" ShowClearFilterButton="True">
                                        <CustomButtons>
                                             <dx:GridViewCommandColumnCustomButton ID="btnEditVideo">
                                                <Image IconID="mail_editcontact_16x16" ToolTip="Edit Video">
                                                </Image>
