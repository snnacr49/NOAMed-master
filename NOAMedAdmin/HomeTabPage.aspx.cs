...
public partial class HomeTabPage : System.Web.UI.Page
{
    ...
    {
        var list = new DataProcessNoa.Data.NOAEntities().HomeTabPage.Where(u=>u.IsActive==true).OrderByDescending(u=>u.ID).ToList();
    ...
    protected void pnlBack_Callback(object sender, DevExpress.Web.CallbackEventArgsBase e)
    {
        ...
        else if (e.Parameter.Contains("Remove"))
        {
            ...
            var user = ent.HomeTabPage.Find(ID);
            ...
            ent.HomeTabPage.AddOrUpdate(user);
            ent.SaveChanges();
